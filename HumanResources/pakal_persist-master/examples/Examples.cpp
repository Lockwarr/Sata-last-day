...
int main()
{
	test test123 = { "test1", 23, "test2" };
	Pakal::JsonWriter writer;
	writer.write("createdJson.json", "test123", test123);

	Pakal::JsonReader reader;
	test recv1;
	reader.read("createdJson.json", "test123", recv1);
